...
class AddRecipeView extends View{
    ...
    addHandlerRecipes(handler){
        ...
        this._parentItem.addEventListener('submit',function(e){
            ...
            // works as reverse in the case of converting the arrays from object values to the arrays of array
    ...
    _removeClassHidden(){
        this._btnAdd.addEventListener('click',this.togglerFuntion.bind(this))
    }

    _addClassHidden(){
        this._overlay.addEventListener('click',this.togglerFuntion.bind(this));
        this._closeWindow.addEventListener('click',this.togglerFuntion.bind(this));
    }
